                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <select name="year_id" required="" class="form-control">
                                                                ...
                                                                @foreach($years as $StudentYear)
                                                                    <option value="{{ $StudentYear->id }}" {{ ($editData->year_id == $StudentYear->id)? "selected":"" }}  >{{ $StudentYear->name }}</option>
                                                                @endforeach
                                                        ...
                                                        <div class="controls">
                                                            <select name="class_id"  required="" class="form-control">
                                                                ...
                                                                @foreach($classes as $StudentClass)
                                                                    <option value="{{ $StudentClass->id }}" {{ ($editData->class_id == $StudentClass->id)? "selected":"" }} >{{ $StudentClass->name }}</option>
                                                                @endforeach
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <select name="group_id"   required="" class="form-control">
                                                                ...
                                                                @foreach($groups as $StudentGroup)
                                                                    <option value="{{ $StudentGroup->id }}" {{ ($editData->group_id == $StudentGroup->id)? "selected":"" }} >{{ $StudentGroup->name }}</option>
                                                                @endforeach
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <select name="shift_id"  required="" class="form-control">
                                                                ...
                                                                @foreach($shifts as $StudentShift)
                                                                    <option value="{{ $StudentShift->id }}" {{ ($editData->shift_id == $StudentShift->id)? "selected":"" }} >{{ $StudentShift->name }}</option>
                                                                @endforeach
