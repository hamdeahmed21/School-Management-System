                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        @foreach($student_class as $StudentClass )
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('student.class.edit',$StudentClass->id) }}" class="btn btn-info">Edit</a>
                                                    <a href="{{ route('student.class.delete',$StudentClass->id) }}" class="btn btn-danger" id="delete">Delete</a>
