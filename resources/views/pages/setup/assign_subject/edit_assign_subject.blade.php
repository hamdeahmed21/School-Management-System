                                                    ...
                                                    <div class="controls">
                                                        <select name="class_id" required="" class="form-control">
                                                            ...
                                                            @foreach($classes as $StudentClass)
                                                                <option value="{{ $StudentClass->id }}" {{ ($editData['0']->class_id == $StudentClass->id)? "selected":"" }} >{{ $StudentClass->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div> <!-- // end form group -->
                                                                    ...
                                                                    <div class="controls">
                                                                        <select name="subject_id[]" required="" class="form-control">
                                                                            ...
                                                                            @foreach($subjects as $SchoolSubject)
                                                                                <option value="{{ $SchoolSubject->id }}" {{ ($edit->subject_id == $SchoolSubject->id)? "selected": ""  }}>{{ $SchoolSubject->name }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                </div> <!-- // end form group -->
