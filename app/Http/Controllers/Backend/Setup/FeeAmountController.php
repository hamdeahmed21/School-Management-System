...
class FeeAmountController extends Controller
{
    public function ViewFeeAmount(){
        ...
        $FeeCategoryAmounts = FeeAmount::select('fee_category_id')->groupBy('fee_category_id')->get();
    ...
    public function EditFeeAmount($fee_category_id){
        $FeeAmounts = FeeAmount::where('fee_category_id',$fee_category_id)->orderBy('class_id','asc')->get();
        $fee_categories = FeeCategory::all();
        $classes = StudentClass::all();
        return view('backend.setup.fee_amount.edit_fee_amount',compact('FeeAmounts' ,'fee_categories', 'classes'));
    ...
    public function DetailsFeeAmount($fee_category_id){
        $detailsData = FeeAmount::where('fee_category_id',$fee_category_id)->orderBy('class_id','asc')->get();
