...
class AccountStudentFeeController extends Controller
{
    public function StudentFeeView(){
        ...
        return view('pages.account.student_fee.student_fee_view',compact('allData'));
    }
    ...
    public function StudentFeeAdd(){
        ...
        return view('pages.account.student_fee.student_fee_add',compact('years','classes','fee_categories'));
